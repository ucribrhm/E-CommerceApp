...
function NewProduct() {
  ...
  const newProductMutations = useMutation({
    mutationFn: postProduct,
    onSuccess: () => {
      queryClient.invalidateQueries({
        // güncelleme işlemi yapınca sayfayıo yenilesin diye sorguyu sıfırlıyor yeniden çalıştırıyor bir nevi
  ...
  const handleSubmit = (values, bag) => {
    message.loading({ content: "Loading...", key: "product_update ",duration:2 });
    const newvalues = { ...values, photos: JSON.stringify(values.photos) };
    newProductMutations.mutate(newvalues);
  };
